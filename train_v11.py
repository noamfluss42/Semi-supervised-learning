...
def get_config():
    ...
    parser.add_argument('--save_all_models', type=float, default=-1,
                        help='')

    parser.add_argument('--lambda_entropy_stop_epoch', type=float, default=-1,
                        help='')
    parser.add_argument('--lambda_entropy_decay_value', type=float, default=-1,
                        help='')
    parser.add_argument('--lambda_entropy_decay_rate', type=float, default=-1,
                        help='')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.random_missing_labels_num != -1:
        ...
        if args.split_to_superclasses > 0:
            ...
            args.missing_labels.sort()
        elif args.lt_choose_unseen_classes_randomly != 1:
            args.missing_labels = np.array(range(args.random_missing_labels_num))
            args.missing_labels.sort()
        else:
