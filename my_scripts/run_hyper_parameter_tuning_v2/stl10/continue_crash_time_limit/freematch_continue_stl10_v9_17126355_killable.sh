...
#SBATCH --output ./continue_freematch_v9_out_dir/d_17126355_v9_not_killable.out # STDOUT
#SBATCH --killable
#SBATCH --requeue
...
echo "continue d_117126355_v9_not_killable"
# 861 epoch "./saved_models/classic_cv/tuning/freematch_stl10_hyperparameter_tuning/17126355/latest_model.pth"
