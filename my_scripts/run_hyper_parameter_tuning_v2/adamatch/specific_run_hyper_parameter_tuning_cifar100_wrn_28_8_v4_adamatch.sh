...
#SBATCH --output ./adamatch/hyper_parameter_out_cifar100_wrn_28_8_v4_adamatch/d-%j.out # STDOUT
#SBATCH --killable
#SBATCH --requeue
...
echo "specific_run_hyper_parameter_tuning_cifar100_wrn_28_8_v4_adamatch.sh"
python train_v4.py --c config/classic_cv/adamatch/my_scripts/adamatch_cifar100_400_0_hyperparameter_tuning.yaml\
