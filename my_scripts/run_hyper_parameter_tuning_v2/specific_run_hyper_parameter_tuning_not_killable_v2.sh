...
#SBATCH --output ./hyper_parameter_out_v2/d-%j.out # STDOUT
...
python3.7 train_v2.py --c config/classic_cv/flexmatch/my_flexmatch/debug_hyper_parameter_tuning/run_hyper_parameter_tuning/flexmatch_cifar10_40_0_hyperparameter_tuning.yaml\
