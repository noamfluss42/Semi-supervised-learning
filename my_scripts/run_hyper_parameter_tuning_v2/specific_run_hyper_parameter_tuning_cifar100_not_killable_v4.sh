...
#SBATCH --output ./hyper_parameter_out_debug/d_cifar100_not_killable_v4-%j.out # STDOUT
...
echo "run specific_run_hyper_parameter_tuning_cifar100_not_killable_v4.sh"
