...
#SBATCH --output ./hyper_parameter_out_cifar100_wrn_28_8/d_cifar100_wrn_28_8_v8-%j.out # STDOUT
...
echo "specific_run_hyper_parameter_tuning_cifar100_wrn_28_8_v8_not_killable.sh"
python train_v8.py --c config/classic_cv/flexmatch/my_flexmatch/debug_hyper_parameter_tuning/run_hyper_parameter_tuning/flexmatch_cifar100_40_0_hyperparameter_tuning.yaml\
