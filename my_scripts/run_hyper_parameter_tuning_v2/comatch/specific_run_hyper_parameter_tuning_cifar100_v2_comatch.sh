...
#SBATCH --output ./comatch/hyper_parameter_out_cifar100_v2_comatch/d-%j.out # STDOUT
#SBATCH --killable
#SBATCH --requeue
...
echo "specific_run_hyper_parameter_tuning_cifar100_v2_comatch.sh"
python train_v2.py --c config/classic_cv/comatch/my_scripts/comatch_cifar100_400_0_hyperparameter_tuning.yaml\
