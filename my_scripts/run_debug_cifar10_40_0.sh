...
echo "Script Name:my_fixmatch_cifar10_40_0.yaml"
python3.7 train_v2.py --c config/classic_cv/fixmatch/my_fixmatch/my_fixmatch_cifar10_40_0.yaml --slurm_job_id ${SLURM_JOB_ID}
