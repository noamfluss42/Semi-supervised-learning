...
#SBATCH --output ./hyper_parameter_out_v2/d_freematch-%j.out # STDOUT
#SBATCH --killable
#SBATCH --requeue
...
python train_v4.py --c config/classic_cv/adamatch/my_scripts/adamatch_cifar10_40_0_hyperparameter_tuning.yaml\
