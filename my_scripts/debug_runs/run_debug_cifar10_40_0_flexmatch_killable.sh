...
echo "Script Name:my_flexmatch_cifar10_40_1_killable.yaml"
python3.7 train_v2.py --c config/classic_cv/flexmatch/my_flexmatch/my_flexmatch_cifar10_40_1.yaml --slurm_job_id ${SLURM_JOB_ID}
