...
#SBATCH --output ./comatch/hyper_parameter_out_debug/d_cifar100_not_killable_v4-%j.out # STDOUT
...
echo "specific_run_hyper_parameter_tuning_cifar100_v4_comatch_not_killable.sh"
python train_v4.py --c config/classic_cv/comatch/my_scripts/comatch_cifar100_400_0_hyperparameter_tuning.yaml\
