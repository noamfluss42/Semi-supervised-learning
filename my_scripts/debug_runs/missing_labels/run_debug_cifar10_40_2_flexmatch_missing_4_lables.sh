...
echo "Script Name:my_flexmatch_cifar10_40_2_missing_4_lables.yaml"
python3.7 train_v2.py --c config/classic_cv/flexmatch/my_flexmatch/missing_labels/my_flexmatch_cifar10_40_2_missing_4_lables.yaml --slurm_job_id ${SLURM_JOB_ID}
