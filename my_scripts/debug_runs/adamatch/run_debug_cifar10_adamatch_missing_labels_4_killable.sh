...
python3.7 train_v2.py --c config/classic_cv/adamatch/my_scripts/debug_full_run_adamatch_cifar10_40_0.yaml --random_missing_labels_num 4 --slurm_job_id ${SLURM_JOB_ID}
