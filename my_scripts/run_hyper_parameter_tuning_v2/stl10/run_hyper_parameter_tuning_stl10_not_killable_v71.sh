...
#SBATCH --output ./hyper_parameter_out_debug/d_cifar100_not_killable_v71-%j.out # STDOUT
...
echo "run run_hyper_parameter_tuning_cifar100_not_killable_v71.sh"
...
python train_v6.py --c config/classic_cv/flexmatch/flexmatch_stl10_hyperparameter_tuning.yaml\
                        --seed $seed\
