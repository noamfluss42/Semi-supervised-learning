...
echo "Script Name:my_flexmatch_cifar10_40_0_debug_continue.yaml"
python3.7 train_v2.py --c config/classic_cv/flexmatch/my_flexmatch/my_flexmatch_cifar10_40_0_debug_continue.yaml \
                      --slurm_job_id 13821431 --random_missing_labels_num 3 --lambda_entropy 3 \
