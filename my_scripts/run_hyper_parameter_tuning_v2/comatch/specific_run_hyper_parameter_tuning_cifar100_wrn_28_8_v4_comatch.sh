...
#SBATCH --output ./comatch/hyper_parameter_out_cifar100_wrn_28_8_v4_comatch/d-%j.out # STDOUT
#SBATCH --killable
#SBATCH --requeue
...
echo "specific_run_hyper_parameter_tuning_cifar100_28_8_v4_comatch.sh"
