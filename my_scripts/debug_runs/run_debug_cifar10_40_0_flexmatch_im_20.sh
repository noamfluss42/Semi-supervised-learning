...
echo "Script Name:debug_my_flexmatch_cifar10_40_0_im_20.yaml"
python3.7 train_v2.py --c config/classic_cv/flexmatch/my_flexmatch/debug_my_flexmatch_cifar10_40_0_im_20.yaml --slurm_job_id ${SLURM_JOB_ID}
