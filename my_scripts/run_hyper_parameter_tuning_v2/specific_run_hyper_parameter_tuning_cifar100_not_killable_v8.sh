...
#SBATCH --output ./hyper_parameter_out_debug/d_cifar100_not_killable_v8-%j.out # STDOUT
...
echo "run specific_run_hyper_parameter_tuning_cifar100_not_killable_v8.sh"
python train_v8.py --c config/classic_cv/flexmatch/my_flexmatch/debug_hyper_parameter_tuning/run_hyper_parameter_tuning/flexmatch_cifar100_40_0_hyperparameter_tuning_no_batch_size.yaml\
