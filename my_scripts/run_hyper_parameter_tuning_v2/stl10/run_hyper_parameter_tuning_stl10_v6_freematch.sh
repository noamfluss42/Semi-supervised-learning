...
#SBATCH --output ./hyper_parameter_out_debug_freematch/d_cifar100_not_killable_v2_freematch-%j.out # STDOUT
#SBATCH --killable
#SBATCH --requeue
...
echo "run run_hyper_parameter_tuning_stl10_v6_freematch.sh"
...
python train_v6.py --c config/classic_cv/freematch/freematch_stl10_hyperparameter_tuning.yaml\
