...
#SBATCH --output ./hyper_parameter_out_debug_freematch/d_stl10_v122_freematch-%j.out # STDOUT
#SBATCH --killable
#SBATCH --requeue
...
python train_v11.py --c config/classic_cv/freematch/freematch_stl10_hyperparameter_tuning.yaml\
