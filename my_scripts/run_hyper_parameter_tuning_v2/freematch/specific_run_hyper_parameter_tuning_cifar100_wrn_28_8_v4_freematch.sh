...
#SBATCH --output ./freematch/hyper_parameter_out_cifar100_wrn_28_8_v4_freematch/d-%j.out # STDOUT
#SBATCH --killable
#SBATCH --requeue
...
echo "specific_run_hyper_parameter_tuning_cifar100_wrn_28_8_v4_freematch.sh"
python train_v4.py --c config/classic_cv/freematch/my_scripts/freematch_cifar100_40_0_hyperparameter_tuning.yaml\
