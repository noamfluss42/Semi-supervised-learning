...
#SBATCH --output ./freematch/hyper_parameter_out_cifar100_v6_freematch/d-%j.out # STDOUT
...
echo "specific_run_hyper_parameter_tuning_cifar100_v6_freematch_not_killable.sh"
python train_v6.py --c config/classic_cv/freematch/my_scripts/freematch_cifar100_40_0_hyperparameter_tuning.yaml\
